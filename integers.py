...
num1 ** num2 # - вовзведение в степень
...
round(2.3) # 2
round(2.6) # 3
round(2.5) # 2 - округлениев меньшую сторону
round(2.3456, 2) # 2.35
# round(x, [y])округление переданного числа до целого, если указан 'y', то округление  до 'y' 
